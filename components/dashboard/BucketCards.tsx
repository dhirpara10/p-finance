...
function SmallAction({
  ...
  return (
    <button
      type="button"
      onClick={onClick}
      className="flex min-h-[58px] min-w-0 flex-col items-center justify-center gap-1.5 rounded-xl bg-white/[0.04] px-2 py-2.5 text-[11px] text-neutral-300 transition hover:bg-sky-400/10 hover:text-sky-100"
    >
      <Icon size={15} />
