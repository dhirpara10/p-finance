  ...
  return (
    <div className={`relative flex items-center ${className}`}>
      ...
      <input
        ...
        disabled={disabled}
        autoFocus={autoFocus}
        className="min-h-12 w-full rounded-xl border border-white/[0.08] bg-white/[0.045] py-3 pl-8 pr-4 text-white outline-none transition placeholder:text-neutral-600 focus:border-emerald-300/50 focus:bg-white/[0.06] focus:ring-2 focus:ring-emerald-300/10 md:min-h-[52px] disabled:opacity-50"
      />
    </div>
  );
}
